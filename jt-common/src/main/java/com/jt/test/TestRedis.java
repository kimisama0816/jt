...
public class TestRedis {
		 ...
		 */
		/*
		 * @Test public void testString05(){
		 */
		
		/*
		 * //1.创建jedis对象 Jedis jedis = new Jedis("192.168.126.129", 6379);
		 * jedis.flushAll(); //清空所有的redis缓存 SetParams params = new SetParams();
		 * params.xx().ex(20); jedis.set("aa", "测试A", params); jedis.set("aa", "测试B",
		 * params); System.out.println(jedis.get("aa")); }
		 */
